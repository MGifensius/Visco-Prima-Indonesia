...
import { MapPin, Phone, Mail, FileDown, Clock, MessageCircle } from 'lucide-react'
      ...
      <div className="container">
        <div className="footer__grid">
          ...
          <div className="footer__col">
            ...
            <div className="footer__contact-row">
              <MessageCircle size={13} className="footer__contact-icon" />
              <div className="footer__contact-text">
                <span className="footer__contact-label">WhatsApp</span>
                <span className="footer__contact-value"><a href="https://wa.me/6281311556697" target="_blank" rel="noopener noreferrer">+62 813 1155 6697</a></span>
              </div>
            </div>
            <div className="footer__contact-row">
