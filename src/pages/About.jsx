...
import { Shield, Users, Globe, Award, Truck, HeartHandshake, ArrowRight, MapPin, Flame, Snowflake, Filter, Droplets, Wrench, Zap, Phone, MessageCircle } from 'lucide-react'
...
const branches = [
  { city: 'Jakarta Utara', note: 'Kantor Pusat', address: 'Kompleks Perkantoran Northland No 35-36, Jl. R.E. Martadinata – Ancol, Jakarta Utara 14430', phone: '(62-21) 2669 2908', whatsapp: '+6281311556697', main: true },
]
    ...
    <>
      ...
      <section className="section-y bg-surface">
        <div className="container">
          ...
          <div className="about-location-grid gs-reveal">
            <div className="about-location-grid__info">
              {branches.map((b, i) => (
                <div className={`branch-card${b.main ? ' branch-card--main' : ''}`} key={i}>
                  ...
                  <div className="branch-card__contacts">
                    ...
                    {b.whatsapp && (
                      <a href={`https://wa.me/${b.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer" className="branch-card__whatsapp">
            ...
            <div className="about-location-grid__map">
              <iframe
                title="PT. Visco Prima Indonesia — Kantor Pusat"
